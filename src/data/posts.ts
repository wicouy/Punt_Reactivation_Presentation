...
export const posts: Post[] = [
  ...
  },
  {
    ...
    content: [
      {
        type: 'paragraph',
        text: 'Values shown are illustrative — validate against bonus cost, LTV, margin and compliance before launch. Offer type escalates through the journey. Bonus-Sensitive players never receive offer extensions or increases.',
      },
      {
        type: 'table',
        headers: ['Segment', 'Day 1', 'Day 5', 'Day 8', 'Day 11–13'],
        rows: [
          ['VIP', 'VIP Prize Draw Entry + Bundle preview', 'VIP Boosted Bundle + Tournament entry', 'SC Giveaway + VIP Bundle reminder', 'Final VIP Reward — closes tonight'],
          ['High Value', 'Free Spins + Boosted Bundle teaser', 'Boosted Bundle — 48h expiry', 'Tournament Entry + Bundle reminder', 'Final Bundle / SC Giveaway'],
          ['Normal', 'Scratch Card — win SC or Free Spins', 'Free Spins or Scratch Card on recommended game', 'Prize Draw Entry + Free Spins', 'Final Scratch Card / Spins — closes soon'],
          ['Low Value', 'Game Discovery + Prize Draw entry', 'Challenge — small reward on complete', 'Prize Draw — play one game = one entry', 'Content-Led Farewell — new games'],
          ['Bonus-Sensitive', 'Capped Bundle Teaser — one-time', 'Capped Bundle — hard expiry, no extension', 'Capped Offer Reminder — no increase', 'Final Capped Reminder — closes today, final'],
          ['Payment Friction', 'Help-First Message — no promo yet', 'Support + Scratch Card if issue resolved', 'Complete + Free Spins — resolve blocker', 'Support Route Only — no bonus escalation'],
        ],
      },
    ],
  },
